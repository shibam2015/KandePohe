...
class MailHelper
{
    public static function SendMail($TYPE, $DB_INFO = '', $newsid = '')
    {
        ...
        $MailContentArray = array('#NAME#', '#EMAIL_TO#', '#EMAIL#', '#ACTIVATION_LINK#', '#PIN#', '#COMMENT#', '#LINK#', '#EMAIL#', '#USER_NAME#', '#TODAY_DATE#', '#AGE#', '#HEIGHT#', '#RELIGION#', '#MOTHER_TONGUE#', '#COMMUNITY#', '#LOCATION#', '#EDUCATION#', '#PROFESSION#', '#ABOUT_ME#', '#PHOTO#', '#REGISTER_NO#', '#GENDER_TYPE#');
