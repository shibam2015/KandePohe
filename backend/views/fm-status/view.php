...
<div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <p class="text-muted text-center">Father-Mother Status</p>
             </div>
<?= DetailView::widget([
        'model' => $model,
        'attributes' => [
            ...
            'eStatus',
             ...
             <div class="row">
                <div class="col-md-6">
                     <?= Html::a('Update', ['update', 'id' => $model->iFMStatusID], ['class' => 'btn btn-block btn-primary']) ?>
                </div>
                <div class="col-md-6">
                    <?= Html::a('Delete', ['delete', 'id' => $model->iFMStatusID], ['class' => 'btn btn-danger btn-block',
                    'data' => [
