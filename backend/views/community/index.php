...
/* @var $searchModel common\models\MasterCommunitySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Community List';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="master-community-index">
     <div class="row">
        <div class="col-xs-12">
            <div class="box">
    ...
    <p>
        <?= Html::a('Create Community', ['create'], ['class' => 'btn btn-success pull-right']) ?>
    </p>
    <?= GridView::widget([
