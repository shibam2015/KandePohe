            ...
            <ul class="list-group" id="list_all_<?= $ModelInfo->id ?>">
                <li class="list-group-item ">
                    ...
                    <div class="inbox-thread">
                        ...
                        <div class="box-inbox pull-left">
                            <?= Html::img(CommonHelper::getPhotos('USER', $ModelInfo->id, "75" . $ModelInfo->propic, 75, '', 'Yes', CommonHelper::getVisiblePhoto($ModelInfo->id, $ModelInfo->eStatusPhotoModify)), ['width' => '65', 'height' => '', 'alt' => 'Profile', 'class' => '']); ?>
                        </div>
                        <div class="box-inbox3 pull-right">
                            <p class="name">
                                <a href="<?= CommonHelper::getUserUrl($ModelInfo->Registration_Number); ?>">
