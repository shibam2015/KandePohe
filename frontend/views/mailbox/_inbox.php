        ...
        <div class="pull-right" style="padding-top:30px">
            <div class="box-tools" style="display:inline-table">
                <div class="input-group">
                    <input type="text" class="form-control input-sm ng-valid ng-dirty" placeholder="Search"
                           ng-change="searchDB()" ng-model="searchText" name="table_search" title="" tooltip=""
                           data-original-title="Min character length is 3">
...
<table class="table table-bordered pagin-table">
    ...
    <tr dir-paginate="value in data | itemsPerPage:10" total-items="totalItems">
        ...
        <td>
            <button data-toggle="modal" ng-click="edit(value.id)" data-target="#edit-data" class="btn btn-primary">
                Edit
            </button>
...
<dir-pagination-controls class="pull-right" on-page-change="pageChanged(newPageNumber)"
                         template-url="dir-pagination"></dir-pagination-controls>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                ...
                                <div class="form-group">
                                    <input ng-model="form.title" type="text" placeholder="Name" name="title"
            ...
            <form method="POST" name="editItem" role="form" ng-submit="saveEdit()">
                ...
                <div class="modal-body">
                    <div class="container">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="submit" ng-disabled="editItem.$invalid" class="btn btn-primary create-crud">
                            Submit
                        </button>
                    </div>
                </div>
