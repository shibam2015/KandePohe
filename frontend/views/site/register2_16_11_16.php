...
<main>
    <div class="container-fluid">
        <div class="row no-gutter bg-dark">
          ...
          <p><strong>Welcome <?= $model->First_Name; ?> !</strong> Your Educational and Occupation details will help us
              find you the best matches</p>
          </span>
                      ...
                      <a href="index.php?r=site/register3&id=<?= base64_encode($model->id) ?>" class="btn btn-primary mrg-tp-10 col-xs-5 col-xs-5 pull-right">
                                ...
                                <div class="row">
                                    <div class="col-sm-10 col-sm-offset-1">
                                        ...
                                        <a href="<?= $HOME_URL_SITE ?>life-style"
