          ...
          <div class="col-sm-10 col-sm-offset-1">
            ...
            <div class="form-cont">
              <div class="radio" id="IVA">
                <!-- <input id="Male" type="radio" checked="checked" name="sex" value="Yes">
                 <label for="Male">Male</label>
                 <input id="Female" type="radio" name="sex" value="No">
            ...
            <div class="form-cont">
              <!-- <div class="form-cont"> <span class="input input--akira">
                <input class="input__field input__field--akira" type="date" id="Date of Birth" />
                <label class="input__label input__label--akira" for="Date of Birth"> <span class="input__label-content input__label-content--akira"></span> </label>
                </span> </div> -->
            ...
            <div class="row">
              <div class="checkbox col-sm-12" id="cjkbox">
                <!-- <input id="toc" type="checkbox" class="validate[required] checkbox" name="toc" value="YES"  checked readonly> -->
                <!-- <label for="toc" class="control-label toccl">By clicking ‘Sign Up Free’ you agree to our <a href="#" title="Terms">Terms</a></label> -->
              ...
              <div class="col-sm-10 col-sm-offset-1">
                <!-- <input id="toc" type="checkbox" name="toc" value="YES"> -->
                <!-- <label for="toc">By clicking  ‘Sign Up Free’  you agree to our <a href="#" title="Terms">Terms</a></label> -->
                <!-- </div> -->
