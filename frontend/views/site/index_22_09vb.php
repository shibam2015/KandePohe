            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-xs-12">
                        <div class="logo"><a href="index.html" title="logo"> <img src="images/logo1.png" width="250"
                                                                                  height="88" alt="logo" class="img1"
                                                                                  title="Kande Pohe"> </a> <a
                                href="index.html" title="logo"> <img src="images/logo2.png" width="214" height="78"
                                                                     alt="logo" class="img2" title="Kande Pohe"> </a>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xs-12">
                        <div class="menu pull-right">
                            ...
                            <ul class="list-inline">
                                ...
                                <?php } else { ?>
                                    <li><a href="#" title="Login" data-toggle="modal" data-target="#login">Login</a>
                                    </li>
                                    <li><a href="#" title="Sign up Free" data-toggle="modal" data-target="#myModalNorm"
                                           id="suf">Sign up Free</a></li>
                                <?php } ?>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button type="button" class="btn btn-primary mrg-tp-10 col-xs-12" data-toggle="modal"
                        id="signup_model_btn" data-target="#signup_model" style="display: none"></button>
                <div class="row">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                        ...
                        <a class="btn btn-block btn-social btn-facebook"> <i class="fa fa-facebook"></i> Sign in with
                            Facebook </a>
