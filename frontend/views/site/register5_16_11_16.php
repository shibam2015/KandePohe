...
<main>
    <div class="container-fluid">
        <div class="row no-gutter bg-dark">
          ...
          <p><strong>Welcome <?= $model->First_Name; ?> !</strong> About yourself details will help us find you the best
              matches</p>
          </span>
                    ...
                    <div class="row no-gutter">
                        ...
                        <span class="input input--akira input--filled input-textarea">
                          ...
                          <textarea class="input__field input__field--akira" cols="50" rows="5"
                                    name="User[tYourSelf]"><?= ($model->tYourSelf) ?></textarea>
                          <label class="input__label input__label--akira" for="input-22">
                              <span class="input__label-content input__label-content--akira">Describe yourself in your own words</span>
                          </label>
                        </span>
                                        </div>
                                    </div>
