                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="headingfour">
                                                <h4 class="panel-title"><a class="collapsed" role="button"
                                                        ...
                                                        Stars <span class="blue">(669)</span>
                                                        <span class="badge">10</span> <i
                                                            class="fa indicator fa-angle-down"></i> </a></h4>
                                            </div>
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="headingfive">
                                                <h4 class="panel-title"><a class="collapsed" role="button"
                                                                           ...
                                                                           aria-expanded="false"
                                                                           aria-controls="collapsefive"> Family values
                                                        <span class="blue">(669)</span>
                                                        <span class="badge">10</span> <i class="fa fa-angle-down"></i>
                                                    </a></h4>
                                            </div>
                        ...
                        <div class="dashboard-wrapper">
                          ...
                          (<?= ($model->Registration_Number != '') ? $model->Registration_Number : '-'; ?>)
                                            ...
                                            <?php foreach ($ProfileViedByMembers as $Key => $Value) { ?>
                                                <div class="col-xs-6 col-md-6 col-lg-3">
                                                    <div class="item">
                                                        ...
                                                        <p><?= CommonHelper::getAge($Value->fromUserInfo->DOB); ?>
                                                            years,
                                                        ...
                                                        <p class="s__<?= $Value->fromUserInfo->id ?>">
                                                            ...
                                                            if ($Check->from_user_id == Yii::$app->user->identity->id && $Check->to_user_id == $Value->fromUserInfo->id && $Check->send_request_status == "Yes") {
                                                                ?>
                                                                <a href="javascript:void(0)" class="btn btn-link isent"
                                                                   role="button">Interest Sent <i
                                                                        class="fa fa-heart"></i></a>
                                                            <?php } else { ?>
                                                                <a href="javascript:void(0)"
                                                                   class="btn btn-info sendinterestpopup" role="button"
                                                                   ...
                                                                   data-rgnumber="<?= $Value->fromUserInfo->Registration_Number ?>">Send
                                                                    Interest
                            ...
                            <?php if (count($RecentlyJoinedMembers)) { ?>
                                <div class="bg-white mrg-tp-20"><a href="#" title="View All" class="pull-right">View All
                                        &gt;</a>
                                                        ...
                                                        <p class="s__<?= $Value->id ?>">
                                                            ...
                                                            <?php } else { ?>
                                                                <a href="javascript:void(0)"
                                                                   ...
                                                                   data-rgnumber="<?= $Value->Registration_Number ?>">Send
                                                                    Interest
                                                                    <i class="fa fa-heart-o"></i>
                                                                </a>
                                                            <?php } ?>
