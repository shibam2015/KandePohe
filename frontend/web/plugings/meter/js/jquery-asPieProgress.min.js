    ...
    var l = function () {
        ...
        return r(t, [{
            ...
            key: "_drawBar", value: function (t) {
                if (c) {
                    this.barGoal = t;
                    var e = this.size, i = this.size, n = i / 2, s = e / 2, r = 0, a = this.options.barsize, o = Math.min(n, s) - a / 2;
                    this.r = o;
                    var u = this.getPercentage(t);
                    100 === u && (u -= 1e-4);
                    var h = r + u * Math.PI * 2 / 100, l = n + o * Math.sin(r), f = n + o * Math.sin(h), m = s - o * Math.cos(r), d = s - o * Math.cos(h), p = 0;
                    h - r > Math.PI && (p = 1);
            ...
            key: "_updateBar", value: function () {
                if (c) {
                    var t = this.getPercentage(this.now), e = this.bar.getTotalLength(), i = e * (1 - t / this.getPercentage(this.barGoal));
            ...
            key: "go", value: function (t) {
                ...
                var i = e.now, n = l(), s = n + 100 * Math.abs(i - t) * e.options.speed / (e.max - e.min), r = function r(a) {
                    var o = void 0;
                    if (a > s)o = t; else {
