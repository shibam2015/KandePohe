...
_updateBar()
{
    ...
    this.bar.style.strokeDasharray = `${length}
    ${length}
`;
...
)
{
    ...
    // event
    this.$element.trigger(`${NAMESPACE$1}
::${eventType}
`,
    data
)
