    ...
    Croppic.prototype = {
        ...
        loadExistingImage: function () {
            ...
            if ($.isEmptyObject(that.croppedImg)) {
                ...
                that.imgId = that.options.imgId;
                that.imgName = that.options.imgName;
        ...
        initCropper: function () {
            ...
            //that.img.wrap('<div class="cropImgWrapper" style="overflow:hidden; z-index:1; position:absolute; width:200px; height:200px;"></div>');
            //that.img.wrap('<div class="cropImgWrapper" style="overflow:hidden; z-index:1; position:absolute; width:'+that.objW+'px; height:'+that.objH+'px;"></div>');
        ...
        createCropControls: function () {
            ...
            var cropControlZoomIn = '<a class="hovertool" data-original-title="Click for Zoom In" data-toggle="tooltip" data-placement="top"><i class="cropControlZoomIn"></i></a>';
            var cropControlZoomOut = '<a class="hovertool" data-original-title="Click for Zoom Out" data-toggle="tooltip" data-placement="top"><i class="cropControlZoomOut"></i></a>';
            var cropControlZoomMuchOut = '';
            var cropControlRotateLeft = '';
            var cropControlRotateRight = '';
            var cropControlCrop = '<a class="hovertool" data-original-title="Click for save" data-toggle="tooltip" data-placement="top"><i class="cropControlCrop"></i></a>';
            var cropControlReset = '<a class="hovertool" data-original-title="Click for close" data-toggle="tooltip" data-placement="top"><i class="cropControlReset"></i></a>';
            var cropControlClose = '<span class="cropControlClose kp_crop_close">Close</span>';

            var html;

            if (that.options.doubleZoomControls) {
                cropControlZoomMuchIn = '<a class="hovertool" data-original-title="Click for Double Zoom In" data-toggle="tooltip" data-placement="top"><i class="cropControlZoomMuchIn"></i></a>';
                cropControlZoomMuchOut = '<a class="hovertool" data-original-title="Click for Double Zoom Out" data-toggle="tooltip" data-placement="top"><i class="cropControlZoomMuchOut"></i></a>';
            }
            ...
            html = '<div class="cropControls cropControlsCrop">' + cropControlZoomMuchIn + cropControlZoomIn + cropControlZoomOut + cropControlZoomMuchOut + cropControlRotateLeft + cropControlRotateRight + cropControlCrop + cropControlReset + cropControlClose + '</div>';
            ...
            that.cropControlClose = that.cropControlsCrop.find('.cropControlClose');
            that.cropControlClose.on('click', function () {
                $("#croppicModal").remove();
            });
        ...
        afterCrop: function (data) {
            ...
            if (response.status == 'success' || response.STATUS == 'S') {

                if (that.options.imgEyecandy)
                    that.imgEyecandy.hide();

                that.destroy();
                $('.mainpropic').attr('src', response.ProfilePhoto);
                $('.profile_photo_one').attr('src', response.ProfilePhotoThumb);
                $('#photo_list a').find('img').removeClass('selected');
                $('#img_' + that.imgId + ' a').find('img').addClass('selected');
                that.obj.append('<img class="croppedImg" src="' + response.ProfilePhoto + '">');
                if (that.options.outputUrlId !== '') {
            ...
            if (response.status == 'error' || response.STATUS == 'E') {
                if (that.options.onError) that.options.onError.call(that, response.MESSAGE);
                that.hideLoader();
