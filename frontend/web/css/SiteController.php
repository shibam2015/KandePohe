        ...
        if ($model->load(Yii::$app->request->post()) ) {
            ...
            //get verify response data
                ...
                if($model->save()){
                    ...
                    ->setFrom('vcodertechnolab@gmail.com')
                    ...
                    if($model->load(Yii::$app->request->post())){
                        ...
                        if($PIN !=''){
                            ...
                            if($model->pin_email_vaerification == $PIN){
                                ...
                                $model->completed_step = 8;

                                $model->save($model);

                                $this->redirect(['site/dashboard','id'=>base64_encode($id)]);
